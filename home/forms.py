...
class UserLogForm(forms.ModelForm):  #{        
    def __init__(self, *args, **kwargs):
        ...
        self.fields['log_time'].required = False 
        # self.fields['log_time'].widget=forms.SplitDateTimeWidget(attrs={'required':False}) 
        # See if you can use bootstrap
        # self.fields['log_time'].widget=forms.DateTimeField(attrs={'required':False, 'id':'user_log_datetimepicker'}) 
